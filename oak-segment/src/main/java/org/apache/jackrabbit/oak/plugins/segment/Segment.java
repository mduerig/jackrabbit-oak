...
public class Segment {
    ...
    // FIXME michid instead of having to read the GC generation from the segment itself,
    // could we make it part of the tar file index!? This way we could also assign generations
    // to bulk segments
    public int getGcGen() {
