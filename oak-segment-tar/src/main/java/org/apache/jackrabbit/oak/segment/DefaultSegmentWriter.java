...
public class DefaultSegmentWriter implements SegmentWriter {
    ...
    @Override
    @Nonnull
    public RecordId writeMap(@Nullable final MapRecord base, @Nonnull final Map<String, RecordId> changes)
    throws IOException {
    ...
    private class SegmentWriteOperation {
        ...
        SegmentWriteOperation(@Nonnull GCGeneration gcGeneration) {
