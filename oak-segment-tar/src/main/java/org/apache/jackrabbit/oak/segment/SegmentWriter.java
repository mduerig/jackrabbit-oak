...
public interface SegmentWriter {
     ...
     * {@code DefaultSegmentWriter} instance. That is, future calls to {@code #builder()}
     * return a {@code NodeBuilder} that is also bound to the same {@code DefaultSegmentWriter}
