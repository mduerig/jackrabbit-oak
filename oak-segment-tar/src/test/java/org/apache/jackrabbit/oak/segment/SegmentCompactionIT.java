...
public class SegmentCompactionIT {
    ...
    private volatile int maxBlobSize = 50000;
    ...
    private volatile int nodeRemoveRatio = 20;
    private volatile int propertyRemoveRatio = 20;
    private volatile int nodeAddRatio = 50;
    private volatile int addStringRatio = 9;
    private volatile int addBinaryRatio = 1;
