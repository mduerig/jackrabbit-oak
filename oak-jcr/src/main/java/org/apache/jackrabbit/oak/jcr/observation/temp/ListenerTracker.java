...
package org.apache.jackrabbit.oak.jcr.observation.temp;
...
public class ListenerTracker {
    ...
    /**
     * Called just before the {@link EventListener#onEvent(javax.jcr.observation.EventIterator)}
    ...
    /**
     * Called just after the {@link EventListener#onEvent(javax.jcr.observation.EventIterator)}
